...
<form action="<?= basename(__FILE__); ?>" method="post">
  ...
  <input type="logemail" name="email" id="" placeholder="exemple@gmail.com" value="<?= !empty($_POST['logemail']) ?  $_POST['logemail'] : '' ?>">
  <div class="eremail"></div>
  <label for="logmdp">Mot de passe : </label>
  <input type="password" placeholder="Mot de passe de 6 caracteres" name="mdp" value="<?= !empty($_POST['logmdp']) ?  $_POST['logmdp'] : '' ?>">
  <div class="ermdp"></div>
  <input type="submit" name="logsubmit" value="💩">
  <div class="er"></div>
</form>
<?php
