        ...
        <div class="slider">
            ...
            <div class="slider-line">
                <?php $img = array_diff(scandir("../assets/ressources/materiel/400/" . $row['img']), [".", ".."]);
                        foreach ($img as $img) {
                        ?>
                <img src="../assets/ressources/materiel/400/<?= $row['img'] ?>/<?= $img ?>" alt=" image du materiel" class="img_matos">
                <?php } ?>
                            </div>
            ...
            <button class="slider-next" type="none">next</button>
                ...
                <form action="<?= basename(__FILE__) . "?id=" . $id ?>" method="post">
                    <div class="description">
                        ...
                        <p class="sRef">Refference : <?= $row['reference']; ?><input type="text" id="reference"
                                class="modif none"></p>
                        <p class="sDesc">description : <?= $row['description']; ?><input type="text" id="description"
                                class="modif none"></p>
                    </div>
            </div>
        </div>
